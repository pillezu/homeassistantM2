...
class TemperatureSettingTrait(_Trait):
    ...
    async def execute(self, command, data, params, challenge):
        ...
        if command == COMMAND_THERMOSTAT_TEMPERATURE_SETPOINT:
            await self.executeCommandThermostatTemparatureSetpoint(
                data, params, unit, min_temp, max_temp
            )

        elif command == COMMAND_THERMOSTAT_TEMPERATURE_SET_RANGE:
            await self.executeCommandThermostatTemparatureSetRange(
                data, params, unit, min_temp, max_temp
            )

        elif command == COMMAND_THERMOSTAT_SET_MODE:
            await self.executeCommandThermostatSetMode(data, params)

    async def executeCommandThermostatTemparatureSetpoint(
        self, data, params, unit, min_temp, max_temp
    ):
        """Execute a temperature set point."""
    ...
    async def executeCommandThermostatTemparatureSetRange(
        self, data, params, unit, min_temp, max_temp
    ):
        """Execute a temperature point range command."""
    ...
    async def executeCommandThermostatSetMode(self, data, params):
        """Execute a temperature set mode command."""
